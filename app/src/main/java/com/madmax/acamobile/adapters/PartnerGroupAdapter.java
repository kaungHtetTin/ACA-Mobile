...
public class PartnerGroupAdapter extends RecyclerView.Adapter<PartnerGroupAdapter.Holder> {

    private final Activity c;
    private final ArrayList<MyGroupModel> data;
    private final LayoutInflater mInflater;

    public PartnerGroupAdapter(Activity c, ArrayList<MyGroupModel> data){
        this.data=data;
        this.c=c;
    ...
    @NonNull
    @Override
    public PartnerGroupAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PartnerGroupAdapter.Holder holder, int position) {
        try{
        ...
        public Holder(View view){
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(c, PartnerGroupDetailActivity.class);
